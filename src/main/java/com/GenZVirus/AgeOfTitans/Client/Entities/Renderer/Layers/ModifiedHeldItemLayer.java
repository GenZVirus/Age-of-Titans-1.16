package com.GenZVirus.AgeOfTitans.Client.Entities.Renderer.Layers;
...
@OnlyIn(Dist.CLIENT)
public class ModifiedHeldItemLayer<T extends LivingEntity, M extends EntityModel<T> & IHasArm> extends LayerRenderer<T, M> {
	public ModifiedHeldItemLayer(IEntityRenderer<T, M> p_i50934_1_) {
		super(p_i50934_1_);
	}

	@SuppressWarnings("unused")
	public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks,
		...
		if (!itemstack.isEmpty() || !itemstack1.isEmpty()) {
			...
			if (itemstack1.getItem().equals(ItemInit.TITAN_HEART.get())) {
	...
	private void func_229135_a_(LivingEntity p_229135_1_, ItemStack p_229135_2_, ItemCameraTransforms.TransformType p_229135_3_, HandSide p_229135_4_, MatrixStack p_229135_5_,
