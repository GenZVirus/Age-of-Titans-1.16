...
//			throw new IllegalArgumentException("Corrupted NBT: Number of inventory slots did not match expected.");
	...
	public ITextComponent getDisplayName() {
		return new TranslationTextComponent("container.ageoftitans.black_hole");
	}
	...
	public Container createMenu(int windowID, PlayerInventory playerInventory, PlayerEntity playerEntity) {
		container = ContainerBasic.createContainerServerSide(windowID, playerInventory, chestContents);
		return container;
	}
	
	public final ChestContents chestContents; // holds the ItemStacks in the Chest
}